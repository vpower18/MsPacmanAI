...
import pacman.entries.pacman.Evolution;
...
{	
	...
	public static void main(String[] args)
	{
		...
		List<String> topRules = new ArrayList<String>();		
		...
		for(int loop = 0; loop < 5000; ++loop){
			for(int i = 0; i < 3; ++i){
				topScores.add(0);
				topRules.add("rules1.txt");
			}
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//exec.runGameTimed(new NearestPillPacMan(),new AggressiveGhosts(),visual);
			for(int i = 1; i <= numRuleSets; i++){
				////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				exec.runGameTimed(new MyPacMan("rules"+i+".txt"),new AggressiveGhosts(),visual);
				//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				if(currentScore > topScores.get(0)){
					topScores.set(0,  currentScore);
					topRules.set(0, "rules"+i+".txt");				
				}
				else if(currentScore > topScores.get(1)){
					topScores.set(1,  currentScore);
					topRules.set(1, "rules"+i+".txt");	
				}
				else if(currentScore > topScores.get(2)){
					topScores.set(2,  currentScore);
			...
			IO.saveFile(topRules.get(2), Evolution.getInstance().propogateRules(parentRules[2], parentRules[1]), false);
		}
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
